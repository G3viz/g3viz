---
title: 'G3viz: explore genetic mutations of multiple genes using Shiny'
...
vignette: >
  ...
  %\VignetteIndexEntry{3. Shiny example}
...
Here is an example to use Shiny to explore genetic mutations in multiple genes.
