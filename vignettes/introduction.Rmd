...
1. [Usage](#usage)
    ...
    * [Visualize genomic mutation data via a lollipop diagram in a web browser](#view)
...
```
 ...
 <img src="./figures/MSK_IMPACT_2017_TP53.png" width="580px">
...
<img src="./figures/TCGA_BRCA_PIK3CA.png" width="600px">
...
```
 ...
 <img src="./figures/CCLE_APC.png" width="800px">
...
loaded via a namespace (and not attached):
 [1] htmlwidgets_1.3   compiler_3.5.1    magrittr_1.5      htmltools_0.3.6   tools_3.5.1       yaml_2.2.0       
 [7] cgdsr_1.2.10      Rcpp_1.0.0        stringi_1.3.1     R.methodsS3_1.7.1 stringr_1.4.0     jsonlite_1.6     
[13] digest_0.6.18     R.oo_1.22.0
```
