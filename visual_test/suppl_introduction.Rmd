...
vignette: >
  ...
  %\VignetteIndexEntry{Introduction to g3viz (pdf)}
...
kable(mutation.mapping.df,  longtable = TRUE, booktabs = TRUE, caption = "Variant classification to mutation class mapping table") %>% 
...
The `g3viz` package contains 8 ready-to-use chart schemes: *default*, *blue*, *simple*, *cbioportal*, *nature*, *nature2*, *ggplot2*, and *dark*.  Check [online live demo](./chart_themes.html) or [online pdf](./suppl_chart_themes.pdf) for usage and examples.
