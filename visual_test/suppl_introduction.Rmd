...
```
```{r, chunk-label, out.width = "6in", fig.align='center', fig.cap='g3viz lollipop-diagram with default theme', echo = FALSE}
knitr::include_graphics("figures/suppl_fig1.png")
```
...
custom [chart options](#options).  Note this is equivalent to *dark* chart theme.
...
```{r, chunk-label3, out.width = "6in", fig.align='center', fig.cap='g3viz lollipop-diagram with custom chart options (equivalent to dark theme)', echo = FALSE}
knitr::include_graphics("figures/suppl_fig2.png")
```
...
#> legend title is set to Mutation_Class
```
```{r, chunk-label1, out.width = "6in", fig.align='center', fig.cap='g3viz lollipop-diagram with cbioportal theme', echo = FALSE}
knitr::include_graphics("figures/suppl_fig3.png")
```
...
kable(mutation.mapping.df, caption = "Variant classification to mutation class mapping table") %>% 
...
The `g3viz` package contains 8 ready-to-use chart schemes: *default*, *blue*, *simple*, *cbioportal*, *nature*, *nature2*, *ggplot2*, and *dark*.  Check [online vignettes](https://cran.r-project.org/web/packages/g3viz/vignettes/chart_themes.html) or supplementary document for usage and examples.



## <a name="schemes"></a> Color schemes

[Figure 4](#color_scheme_fig) demonstrates all color schemes that `g3viz` supports for lollipop-pops and Pfam domains.  More demos are available at [demo 1](https://bl.ocks.org/phoeguo/raw/2868503a074a6441b5ae6d987f150d48/), [demo 2](https://bl.ocks.org/phoeguo/raw/de79b9ce9bda958173af9891ab7aec93/), and [demo 3](https://bl.ocks.org/phoeguo/raw/81dffe0c7c6c8caae06f6a5f60c70d19/).

<a name="color_scheme_fig"></a>
```{r, chunk-label2, out.width = "540px", fig.align='center', fig.cap='List of color schemes supported by g3viz', echo = FALSE}
...
kable(chart.options.df, longtable = TRUE, booktabs = TRUE, caption = "Chart options of g3viz") %>% 
