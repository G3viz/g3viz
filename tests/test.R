...
g3Lollipop(mutation.dat,
           plot.options =
             g3Lollipop.theme.options(theme.name = "default",
...
g3Lollipop(mutation.dat,
           plot.options =
             g3Lollipop.theme.options(theme.name = "blue",
...
g3Lollipop(mutation.dat,
           plot.options =
             g3Lollipop.theme.options(theme.name = "simple",
...
g3Lollipop(mutation.dat,
           plot.options =
             g3Lollipop.theme.options(theme.name = "cbioportal",
...
g3Lollipop(mutation.dat,
           plot.options =
             g3Lollipop.theme.options(theme.name = "nature",
...
g3Lollipop(mutation.dat,
           plot.options =
             g3Lollipop.theme.options(theme.name = "ggplot2",
